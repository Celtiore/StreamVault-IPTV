...
data class SettingsUiState(
    ...
    val driveAuthState: com.streamvault.domain.manager.DriveAuthState = com.streamvault.domain.manager.DriveAuthState.SignedOut,
    val driveSyncStatus: com.streamvault.domain.manager.DriveSyncStatus = com.streamvault.domain.manager.DriveSyncStatus(),
